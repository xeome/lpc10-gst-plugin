...
extern int hp100_(real* speech, integer* start, integer* end, struct lpc10_encoder_state* st);
...
/* INITHP100. */
/* Subroutine */ int hp100_(real* speech, integer* start, integer* end, struct lpc10_encoder_state* st) {
