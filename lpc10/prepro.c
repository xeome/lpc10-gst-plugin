...
extern int prepro_(real* speech, integer* length, struct lpc10_encoder_state* st);
...
/* Subroutine */ int prepro_(real* speech, integer* length, struct lpc10_encoder_state* st) {
